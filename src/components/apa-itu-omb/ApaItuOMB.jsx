...
const ApaItuOMB = () => {
    ...
    return (
        <section
        id="tentang-omb"
        className="grid grid-cols-1 md:grid-cols-2 items-center w-full h-screen py-0 px-10 mt-16 relative bg-white rounded-br-3xl rounded-bl-3xl shadow-2xl border border-gray-300 z-10"
        >
