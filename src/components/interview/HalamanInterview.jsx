        ...
        {listInterview.map((divisi, index) => (
          <button
            ...
            className={`relative px-10 py-4 rounded-full text-white font-bold 
              backdrop-blur-sm shadow-[0_4px_10px_rgba(0,0,0,0.6)] 
            ...
            style={{
              ...
              color: selectedDivisi === divisi ? divisi.color : "#ffffff",
              border: `2px solid ${divisi.color}`,
            }}
            onMouseEnter={(e) => (e.target.style.color = divisi.color)}
            onMouseLeave={(e) =>
              (e.target.style.color = selectedDivisi === divisi ? divisi.color : "#ffffff")
            }
