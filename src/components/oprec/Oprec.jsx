            ...
            <section className="oprec">
                ...
                <div id="oprec-section" className="OprecText">
                    <div className="OprecHeader">
                        <h1>Kura-kura Matahari menyanyi dalam harmoni,
                            <br />
                        Jangan lewatkan kesempatan ini!</h1>
                    </div>
                ...
                <AnimatePresence>
                    <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50 text-blue-950">
                        <motion.div
                            ...
                            className="relative bg-gray-100 p-6 max-w-[600px] w-full max-h-[70vh] overflow-y-auto rounded-xl shadow-lg flex flex-col z-1001"
                        >
                            <button
