                    ...
                    <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50 text-blue-950">
                        ...
                        >
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {/* Kotak Kosong (isi dengan Foto) */}
                                <div className="flex items-center justify-center bg-gray-300 rounded-lg w-full h-48 border border-gray-500">
                                    {selectedDivisi.foto ? (
                                        <img
                                            src={selectedDivisi.foto} 
                                            alt={`Foto ${selectedDivisi.name}`} 
                                            className="w-full h-full object-cover rounded-lg"
                                        />
                                    ) : (
                                        <p className="text-gray-500">Foto belum tersedia</p>
                                    )}
                                </div>
